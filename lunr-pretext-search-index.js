...
},
{
  ...
  "number": "6.2",
  "title": "Chapter Exercises",
  "body": " Chapter Exercises    A boat is sailing on the lake. At seconds the boat is located at meters and has a velocity of meters per second. Later at seconds the boat is located at meters and has an x-component of velocity equal to meters per second. What is the average velocity and average acceleration of the boat?      A boat is sailing on the lake. At seconds the boat is located at meters and has a velocity of meters per second. Later at seconds the boat is located at meters and has an x-component of velocity equal to meters per second. What is the average velocity and average acceleration of the boat?      A boat is sailing on the lake. At seconds the boat is located at meters and has a velocity of meters per second. Later at seconds the boat is located at meters and has an x-component of velocity equal to meters per second. What is the average velocity and average acceleration of the boat?      A boat is sailing on the lake. At seconds the boat is located at meters and has a velocity of meters per second. Later at seconds the boat is located at meters and has an x-component of velocity equal to meters per second. What is the average velocity and average acceleration of the boat?    "
},
{
...
{
  "id": "subsec-alg-work-from-mult-forces-2",
  "level": "2",
  "url": "sec-work.html#subsec-alg-work-from-mult-forces-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "net work "
},
{
  ...
  "body": " Work-Kinetic Energy Theorem  Recall from the that the kinetic energy of an object is the energy it has due to its motion, and that is mathimatically given by    Work-Kinetic Energy Theorem   The net work done on a system is given by     We can't examine the proof for the general theorem because it requires calculus. However, we can prove that theorem is true for work done by a constant net force over a straight line displacement. In this case we have and by Newton's Second Law we have Then Since the net force is constant over the displacement the acceleration must be constant also by Newton's Second Law. Then we can use the equations of kinematices to get rid of the components of acceleration. In particular, consider the following rearrangements of kinematic equations: Plugging these these in, we get     "
},
{
...
{
  "id": "sec-alg-momentum-impulse-3",
  "level": "2",
  "url": "sec-alg-momentum-impulse.html#sec-alg-momentum-impulse-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "net impulse "
},
{
  ...
  "level": "2",
  "url": "sec-alg-momentum-impulse.html#exercises-sec-calc-impulse-1",
  "type": "Exercise",
  "number": "17.1.1",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-alg-momentum-impulse.html#exercises-sec-calc-impulse-2",
  "type": "Exercise",
  "number": "17.1.2",
  "title": "",
...
},
{
  ...
  "body": " Formula for Center of Mass   We've seen previously that momentum of an isolated system is conserved. However, if there are too many particles in the system, it would be difficult to add so many sources to get the total momentum. To examine the motion of large groups of particles, we need to create a definition for where the center of mass of the system is. This is based on averaging.    Suppose you had a simple isolated system of two grains of wheat. One grain is at x=0.0m and one grain is at x=2.0m. What would you say the average x position ( ) of the system was?     Suppose you had a simple isolated system of three grains of wheat. One grain is at x=0.0m, one grain is at x=4.0m, and one grain is at x=5.0m. What would you say the average x position ( ) of the system was?     Suppose you had a simple isolated system of four grains of wheat. One grain is at x=1.0m, and three grains are all at x=5.0m. What would you say the average x position ( ) of the system was?     Suppose you had an isolated system of 101 grams of flour. 100 grams are making up a cake at x=1.00m, and one gram is at x=5.00m. What would you say the average x position ( ) of the system was, to 3 significant figures?     Suppose you had an isolated system of flour. 200 grams are making up a cake at x=2.00m, 50 grams are making up a cake at x=3.00m, and 350 grams are making up a cake at x=5.00m. What would you say the average x position ( ) of the system was, to 3 significant figures?     So, in general, to get the average x position, we need to take the (in kilogram) of the each object and multiply that by the (in m) of that object, add all the answers together, and then divide by the grand total of all the objects together. This is called a mass-weighted average, and we also call that the “center of mass” or “centroid”: Writing the sum using the sum symbol, If we had been calculating the center of mass along the y coordinate, the equation would be: Finally, if we had been calculating the center of mass along the z coordinate, the equation would be: So, the position in 3-D of the center of mass is:    "
},
{
...
{
  "id": "def-avg-ang-vel-z",
  "level": "2",
  "url": "sec-rot-kin.html#def-avg-ang-vel-z",
  "type": "Definition",
  "number": "18.1.3",
  "title": "",
  "body": "  We define the z-component of the average angular velocity as    "
},
{
  "id": "def-avg-ang-acc-z",
  "level": "2",
  "url": "sec-rot-kin.html#def-avg-ang-acc-z",
  "type": "Definition",
  "number": "18.1.4",
  "title": "",
  "body": "  Similarly we can define the z-component of the average angular acceleration as.    "
},
{
  ...
  "number": "18.1.5",
  "title": "",
  "body": "  If is constant then     If the z-component of the angular acceleration is constant then by we have Rearranging, we get    "
},
{
...
},
{
  ...
  "body": " Circular Motion   Now we want to relate linear and angular kinematics for circular motion, but first we need to take a detour to further explore polar coordinates.    Relating Cartesian and Polar Coordinate Systems  Unit vectors point in the direction that increases the coordinate they're associated but keeps the other coordinates constant. In the cartesian coordinate system the unit vector points in the direction that increases but keeps constant. The unit vector points in the direction that increases but keeps constant.   A Cartesian grid with the Cartesian unit vectors at two different points. From each point, two black arrows extend: one arrow points horizontally to the right, representing the positive x-unit direction, and the other arrow points vertically upward, representing the positive y-unit direction. The right-pointing arrow is labeled , and the upward-pointing arrow is labeled .   A Cartesian grid with the Cartesian unit vectors at two different points.    Cartesian coordinates are special because the unit vectors point in the same direction everywhere (They don't depend on the the position ). Polar coordinates are defined by the radius and angle where is in radians.   A polar coordinate grid contains five concentric circles and twelve evenly spaced radial lines, forming a full 360-degree polar layout. A small solid dot marks the center of the grid. Two separate pairs of unit vectors are drawn at different angular positions on the grid. Each pair of unit vectors originates from a small black point located on one of the circles. In each pair , one arrow represents the r-hat direction (pointing radially outward from the center), and the other arrow represents the -hat direction (pointing tangentially in the clockwise direction to the circle it lies on). Each arrow has a small arrowhead and is labeled with a bold character: for the radial unit vector and for the angular unit vector.   Polar grid with two sets of polar unit vectors labeled r-hat and theta-hat at different positions.    Unit vectors point in the direction that increases their coordinate but keeps the other coordinats constant. Therefore, the unit vector points in the direction that increases , but keeps constant. Likewise the unit vector points in the direction that increases , but keeps constant. The direction of unit vectors in polar coordinates depends on position . The fact that unit vectors for polar coordinates depend on position is usually undesirable. Let's express them in terms of cartesian unit vectors which don't depend on position to deal with this.   A coordinate system with horizontal x-axis and vertical y-axis intersects at the center of a large circle. The circle represents a path of circular motion. A point on the circle, located in the upper-right quadrant, is marked with a small filled dot. A straight radius line extends from the center of the circle to this point. The angle between the radius line and the x-axis is labeled as . Four short arrows originate at the point on the circle, indicating directions of basis vectors. A vector labeled points horizontally to the right. A vector labeled points vertically up. A vector labeled points radially outward from the center of the circle. A vector labeled points tangentially in the clockwise direction to the circle at that point. The vector makes and angle with the vector. The vector alos makes and angle with the vector.   A diagram showing the angles between the polar and cartesian unit vectors at a point on a circle.    By projecting the and unit vectors onto the and unit vectors we get the following equations:      Circular Motion  Now we have the tools we need to relate linear and angular kinematics in circular motion.    The average speed of an object undergoing circular motion is     From and equation we have Then by we have       The instantaneous speed of an object undergoing circular motion is     From the proof of , we have If in becomes extremely small compared to the objects velocity then we get a good approximation of the speed the object has at any given instant. If we call the instantaneous z-component of the angular velocity and acknowledge that the instantaneous speed is the magnitude of velocity we obtain the result we want.      The velocity of an object undergoing circular motion is     We already know the magnitude of the velocity from , so we'll focus on getting the direction at any instant. Since the object is undergoing circular motion, it is constrained to stay on a circle of constant radius . Then at any instant, if is positive it can only be moving in the direction that increases but keeps constant. As we discussed earlier in this section, is the unique unit vector pointing in this direction at any location on the circle.    The easiest way to understand instantaneous acceleration of an object undergoing circular motion is to break it down into its and components. We can break the acceleration into its and components in exactly the same way we broke the acceleration down into its - and -components earlier in the course. the component of acceleration is called the radial or centripedal component of acceleration . centripedal is latin word that means center seeking. The component of acceleration is called the tangential component of acceleration becaue always points in a direction that is tangent to the circle.    For an object undergoing circular motion, the radial component of acceleration is     The acceleration of an object undergoing circular motion can be broken down into a tangential component which is the projection of onto the direction and a radial component which is the projection of onto the direction.   The image shows a circle representing a circular path. A vertical line extends from the center of the circle to the top of the circle. The vertical line represents the radius of the circle and is labeled r. From the top point on the circle, a horizontal arrow points to the left. The horizontal arrow represents the tangential displacement which has a length of . From the top of the tangential displacement vector an arrow points in the direction of the center of the circle and extends to the surface of the circle. This arrow represents the radial displacement vector which has a length of . From the tip of the radial displacement vector and the surface of the circle, a line extends radially in to the center of the circle. The length of this line is the radius of the circle and is labeled r. The radial displacement vector and the nonvertical line labeled r make up the hypotenuse of a right triangle. The other sides of the triangle are the vertical line labeled r and the tangential displacement vector.   Diagram of a circle with radial and tangential displacement vectors labeled with acceleration-based expressions.    Figure x shows the change in position of an object undergoing circular motion over a very short period of time . Since the period of time is so small we can approximate the acceleration as constant over this interval. During that period of time the displacements in the and directions must add up to keep the object on the circle. and point in the direction, so according to the total displacment in the direction is Since the is tangent to the circle, this displacement tries to get the object to fly off the circle in a straight line.  To keep the object from flying off, we must have the radial displacement be in the direction (towards the center of the circle) to keep the object on circle. is the projection of unto the positive direction. To relate to the projection of unto the direct we note that So the projection of along is . According to the displacement in the direction is Now we can use the pythagorean theorem to solve for . We want to know the radial component of the instantaneous acceleration. To get the radial component of the acceleration at an instant we need . Plugging in zero for gives       For an object undergoing circular motion, the tangential componenet of acceleration is     The average tangential acceleration is given by where is the change in speed and is the change in time. Plugging in the formula for the instantaneous speed from gives By definition we have If in becomes extremely small compared to the objects angular acceleration then we get a good approximation of the z-component of angular acceleration the object has at any given instant. If we call the instantaneous z-component of the angular acceleration and we call the instantaneous tangential acceleration we obtain the result we want.    Plugging into gives another useful formula for the radial component of the acceleration.  Finally, the radial and tangential components of the acceleration are always orthogonal (at a right angle to each other) so we can use the pythagorean theorem to get    "
},
{
...
{
  "id": "thm-avg-speed-circ-motion",
  "level": "2",
  "url": "sec-circ-motion.html#thm-avg-speed-circ-motion",
  "type": "Theorem",
  "number": "18.2.4",
  "title": "",
  "body": "  The average speed of an object undergoing circular motion is     From and equation we have Then by we have    "
},
{
  "id": "thm-inst-speed-circ-motion",
  "level": "2",
  "url": "sec-circ-motion.html#thm-inst-speed-circ-motion",
  "type": "Theorem",
  "number": "18.2.5",
  "title": "",
  "body": "  The instantaneous speed of an object undergoing circular motion is     From the proof of , we have If in becomes extremely small compared to the objects velocity then we get a good approximation of the speed the object has at any given instant. If we call the instantaneous z-component of the angular velocity and acknowledge that the instantaneous speed is the magnitude of velocity we obtain the result we want.   "
},
{
  "id": "thm-alg-vel-circ-motion",
  "level": "2",
  "url": "sec-circ-motion.html#thm-alg-vel-circ-motion",
  "type": "Theorem",
  "number": "18.2.6",
  "title": "",
  "body": "  The velocity of an object undergoing circular motion is     We already know the magnitude of the velocity from , so we'll focus on getting the direction at any instant. Since the object is undergoing circular motion, it is constrained to stay on a circle of constant radius . Then at any instant, if is positive it can only be moving in the direction that increases but keeps constant. As we discussed earlier in this section, is the unique unit vector pointing in this direction at any location on the circle.   "
},
{
  "id": "thm-rad-comp-acc-circ-motion",
  "level": "2",
  "url": "sec-circ-motion.html#thm-rad-comp-acc-circ-motion",
  "type": "Theorem",
  "number": "18.2.7",
  "title": "",
  "body": "  For an object undergoing circular motion, the radial component of acceleration is     The acceleration of an object undergoing circular motion can be broken down into a tangential component which is the projection of onto the direction and a radial component which is the projection of onto the direction.   The image shows a circle representing a circular path. A vertical line extends from the center of the circle to the top of the circle. The vertical line represents the radius of the circle and is labeled r. From the top point on the circle, a horizontal arrow points to the left. The horizontal arrow represents the tangential displacement which has a length of . From the top of the tangential displacement vector an arrow points in the direction of the center of the circle and extends to the surface of the circle. This arrow represents the radial displacement vector which has a length of . From the tip of the radial displacement vector and the surface of the circle, a line extends radially in to the center of the circle. The length of this line is the radius of the circle and is labeled r. The radial displacement vector and the nonvertical line labeled r make up the hypotenuse of a right triangle. The other sides of the triangle are the vertical line labeled r and the tangential displacement vector.   Diagram of a circle with radial and tangential displacement vectors labeled with acceleration-based expressions.    Figure x shows the change in position of an object undergoing circular motion over a very short period of time . Since the period of time is so small we can approximate the acceleration as constant over this interval. During that period of time the displacements in the and directions must add up to keep the object on the circle. and point in the direction, so according to the total displacment in the direction is Since the is tangent to the circle, this displacement tries to get the object to fly off the circle in a straight line.  To keep the object from flying off, we must have the radial displacement be in the direction (towards the center of the circle) to keep the object on circle. is the projection of unto the positive direction. To relate to the projection of unto the direct we note that So the projection of along is . According to the displacement in the direction is Now we can use the pythagorean theorem to solve for . We want to know the radial component of the instantaneous acceleration. To get the radial component of the acceleration at an instant we need . Plugging in zero for gives    "
},
{
  "id": "thm-tang-comp-acc-circ-motion",
  "level": "2",
  "url": "sec-circ-motion.html#thm-tang-comp-acc-circ-motion",
  "type": "Theorem",
  "number": "18.2.9",
  "title": "",
  "body": "  For an object undergoing circular motion, the tangential componenet of acceleration is     The average tangential acceleration is given by where is the change in speed and is the change in time. Plugging in the formula for the instantaneous speed from gives By definition we have If in becomes extremely small compared to the objects angular acceleration then we get a good approximation of the z-component of angular acceleration the object has at any given instant. If we call the instantaneous z-component of the angular acceleration and we call the instantaneous tangential acceleration we obtain the result we want.   "
},
{
  "id": "sec-ucm",
  "level": "1",
